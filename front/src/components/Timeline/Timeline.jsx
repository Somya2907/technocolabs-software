...
import '../Tasks/bootstrap.min.css';
import '../Tasks/jquery-nestable.css';
import '../Tasks/bootstrap-datepicker.min.css';
...
function Timeline() {
  ...
  return (
    <>
    <div class="tab-pane fade show active align-center " id="pills-timeline" role="tabpanel" aria-labelledby="pills-timeline-tab">
    <div class="section-body mt-4 align-left">
